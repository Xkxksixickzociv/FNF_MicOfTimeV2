...
idle_xml_name = 'ben idle'
left_xml_name = 'ben left'
down_xml_name = 'ben down'
up_xml_name = 'ben up'
right_xml_name = 'ben right'
...
name_of_character_xml = 'benRipBozo'
name_of_character = 'ben'
name_of_notetype = 'BEN sing'
